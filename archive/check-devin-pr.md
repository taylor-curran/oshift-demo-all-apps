...
IMPORTANT
Use kind to run k8s and docker desktop to run images locally
Test the openshift implementation NOT korifi! Openshift is the target of our migration efforts! 
